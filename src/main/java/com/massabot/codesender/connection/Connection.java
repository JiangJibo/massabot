...
import com.massabot.codesender.AbstractCommunicator;
...
public abstract class Connection {
	...
	abstract public BlockingQueue<SerialPortEventHolder> getCallBack();

	abstract public void startReceivingGcode(); // 开启示教功能

	abstract public void pauseReceivingGcode(); // 结束示教功能

	abstract public void finishReceivingGcode();

	abstract public List<String> getReceivedGcodes(); // 获取示教功能生成的Gcodes
}
