...
public interface IController {
	...
	*/
	...
	/**
	 * Jog control. Jogs the machine in the direction specified by vector dirX, dirY, dirZ a
	 * distance specified by stepSize * units.
	 */
	...
	*/
	...
	/**
	 * Indicator to abstract GUIBackend implementation that the contract class will handle ALL state
	 * change events. When this returns true it means things like completing the final command in a
	 * stream will not automatically re-enable buttons.
	 */
