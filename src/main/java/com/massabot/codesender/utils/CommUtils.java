...
public class CommUtils {
	...
	*/
	...
	/**
	 * Returns the number of characters in the list of GcodeCommands and adds the length of the list
	 * representing one newline per command.
	 * 
	 * Synchronized because this list is frequently modified through events, especially at the
	 * beginning of a file transfer.
	 */
