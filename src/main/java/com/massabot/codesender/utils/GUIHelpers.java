...
public class GUIHelpers {
	...
	public static void displayErrorDialog(final String errorMessage) {
		java.awt.EventQueue.invokeLater(() -> {
			...
			NarrowOptionPane.showNarrowDialog(250, errorMessage.replaceAll("\\.\\.", "\\."), Localization.getString("error"), JOptionPane.DEFAULT_OPTION,
	...
	public static void displayHelpDialog(final String helpMessage) {
		java.awt.EventQueue.invokeLater(() -> {
			NarrowOptionPane.showNarrowConfirmDialog(250, helpMessage, Localization.getString("help"), JOptionPane.DEFAULT_OPTION,
