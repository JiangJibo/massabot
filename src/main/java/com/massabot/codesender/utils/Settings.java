...
import com.massabot.codesender.pendantui.PendantConfigBean;
import com.massabot.codesender.types.Macro;
import com.massabot.codesender.types.WindowSettings;
...
public class Settings {
	...
	/**
	 * This method should only be called once during setup, a runtime exception will be thrown if
	...
	/**
	 * The GSON deserialization doesn't do anything beyond initialize what's in the json document.
	 * Call finalizeInitialization() before using the Settings.
	 */
	public Settings() {
	...
	public Integer getLastMacroIndex() {
		// Obviously it would be more efficient to just store the max index value, but this is safer
		// in that it's one less thing
		// to keep in sync.
		int i = -1;
