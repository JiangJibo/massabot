...
public interface IGcodeParser {
	...
	/**
	 * Preprocesses a gcode string and returns one or more strings with the postprocessed gcode
	 * commands. Each of the ICommandProcessors should be applied to the string in the order they
	 * were given to the parser.
	 * 
	 * @param command
