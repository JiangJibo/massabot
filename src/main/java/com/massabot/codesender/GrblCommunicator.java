...
public class GrblCommunicator extends BufferedCommunicator {
	...
	/**
	 * This constructor is for dependency injection so a mock serial device can act as GRBL.
	 */
	protected GrblCommunicator(LinkedBlockingDeque<String> cb, LinkedBlockingDeque<GcodeCommand> asl, Connection c) {
		// Base constructor.
		// this();
