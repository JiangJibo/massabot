 ...
 */
package com.massabot.codesender.listeners;
...
public class ControllerStatus {
	...
	/**
	 * Baseline constructor. This data should always be present. Represents the controller status.
	 * 
	 * @param state
	 *            controller state, i.e. idle/hold/running
	 * @param machineCoord
	 *            controller machine coordinates
	 * @param workCoord
	 *            controller work coordinates
	 */
	 ...
	 */
	public ControllerStatus(String state, Position machineCoord, Position workCoord, Double feedSpeed, Double spindleSpeed, OverridePercents overrides,
			Position workCoordinateOffset, EnabledPins pins, AccessoryStates states) {
		this.state = state;
