package com.massabot.codesender.pendantui;
...
import com.massabot.codesender.model.BackendAPI;
import com.massabot.codesender.model.UGSEvent;
...
public class PendantUI implements ControllerListener {
	...
	public List<PendantURLBean> start() {
		...
		handlers.setHandlers(
				new Handler[] { configContext, sendGcodeContext, adjustManualLocationContext, getSystemStateContext, resourceHandler, new DefaultHandler() });
	...
	/**
	 * Unfortunately, this is not as simple as it seems... since you can have multiple addresses and
	 * some of those may not be available via wireless
	 * 
	 * @return
	 */
